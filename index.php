...
<main>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-area-6 text-center mb-55">
                        ...
                        <p class="section-text">Preparing students to make meaningful contributions to society as engaged citizens and leaders in a complex world</p>
                    </div>
                </div>
            </div>
    ...
    <section class="h6_tuition-area pt-50 pb-50 news_event">
        <div class="container">
            <div class="row g-0 justify-content-between">
                        ...
                        <marquee scrollamount="4" scrolldelay="1" direction="up" onmouseover="this.stop()" onmouseout="this.start()">
                            <div class="announcements-content">
                                <div class="announcement">
                                    <strong>
                                        We are proud to share that Dr. Sr. V. Saveriammal was honored with the prestigious
                                ...
                                <div class="announcement">
                                    <strong>
                                        We congratulate Dr. Sr. V. Saveriammal on this well-deserved recognition and look forward to her continued
                                ...
                                <div class="announcement">
                                    <strong>
                                        This Star of Changing Lives Award was presented by the Honorable Minister for School Education of Tamil Nadu,
                                            Thiru Anbil Mahesh Poyyamozhi, and conferred by the Rotary Club.
                                    </strong>
                                    <hr class="double">
                                </div>
                                <div class="announcement">
                                    <strong>
                                        On <time datetime="2022-09-06">September 6, 2022</time>, the college was honored by the visit of Mother Chiara
                                            Cazzuola<, the Mother General, who inaugurated and blessed the Centenary Block.
                                    </strong>
                                    <hr class="double">
                                </div>
                                <div class="announcement">
                                    <strong>
                                        The ground floor of the new Academic Block was inaugurated on <time datetime="2023-07-24">July 24, 2023</time>,
                                        in the presence of Mother Provincial Sr. Majella Fernando and Most Rev. Anthony Pappusamy D.D., Archbishop
                                            of Madurai.
                                    </strong>
                                </div>
                            </div>
                ...
                <div class="col-xl-5">
                    <div class="section-area-6 text-center">
                        <h2 class="section-title mb-15">Events and Celebration</h2>
                    </div>
                        ...
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <h5 class="h3_teacher-content-title">
                                    ...
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                <h5 class="h3_teacher-content-title">
                                    <a href="facilities.php">Computer Lab</a>
                                </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Comprehensive Library</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                <h5 class="h3_teacher-content-title">
                                    <a href="facilities.php">Smart Classrooms</a>
                                </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Bus Transport</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Office Room</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Multipurpose Hall</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Canteen and Cafeteria</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Staff Rooms</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="h3_teacher-item">
                            <div class="h3_teacher-img w_img">
                                ...
                                <div class="h3_teacher-social">
                                    <h5 class="h3_teacher-content-title">
                                        <a href="facilities.php">Hostel Facilities</a>
                                    </h5>
                                    <a href="facilities.php" class="h6_about-btn theme-btn theme-btn-medium theme-btn-6">Learn More<i class="fa-light fa-arrow-up-right"></i></a>
                                </div>
                            </div>
    ...
    <!-- campus area start -->
    <section class="h6_campus-area fix mt-70 mb-30">
