...
// teacher active 6
const eventActiveSix = new Swiper(".event-active-6", {
	slidesPerView: 1,
	spaceBetween: 30,
	loop: true,
	speed: 2000,
...
const galleryActive = new Swiper(".gallery-active-6", {
	slidesPerView: 1,
	spaceBetween: 30,
	loop: true,
	speed: 2000,
	...
	navigation: {
        nextEl: '.swiper-button-next', // Target the right arrow
        prevEl: '.swiper-button-prev', // Target the left arrow
    },
	breakpoints: {
		0: {
			slidesPerView: 1,
